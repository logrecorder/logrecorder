...
public class LogWatcherExtensionIntTest {
    ...
    static final String LOGGING_CLASS_NAME =
        "info.novatec.testit.testutils.logrecorder.junit5.LogWatcherExtensionIntTest$LoggingClass";
    static final String ANOTHER_LOGGING_CLASS_NAME =
        "info.novatec.testit.testutils.logrecorder.junit5.LogWatcherExtensionIntTest$AnotherLoggingClass";
