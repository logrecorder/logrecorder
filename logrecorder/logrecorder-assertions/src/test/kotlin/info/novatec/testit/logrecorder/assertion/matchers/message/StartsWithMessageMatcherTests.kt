...
internal class StartsWithMessageMatcherTests {
    ...
    fun `has an expressive toString value`() {
        assertThat(matcherFor("foo ..").toString()).isEqualTo("""starts with ["foo .."]""")
    }

    fun matcherFor(prefix: String) = StartsWithMessageMatcher(prefix)
